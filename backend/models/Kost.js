...
const roomSchema = new mongoose.Schema({
  ...
  currentTenant: {
    ...
    extensionTotal: { type: Number, default: 0 },
    extensionPaid: { type: Number, default: 0 },
    extensionRemaining: { type: Number, default: 0 },
    extensionStatus: { type: String, enum: ["lunas", "belum_lunas", "none"], default: "none" },
  },
