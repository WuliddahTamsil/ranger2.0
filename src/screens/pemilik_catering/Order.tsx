          ...
          {selectedOrder.status === "Menunggu" && (
            <View style={styles.dualActionsRow}>
              ...
              <TouchableOpacity
                ...
                activeOpacity={0.8}
              >
                <Text style={styles.sheetBtnTextSolid}>Terima & Mulai Masak</Text>
              </TouchableOpacity>
            </View>
          )}
          ...
          {selectedOrder.status === "Siap" && selectedOrder.driver && (
            <View style={styles.dualActionsRow}>
              ...
              <TouchableOpacity
                ...
                activeOpacity={0.8}
              >
                <Text style={styles.sheetBtnTextSolid}>Kurir Menuju Dapur</Text>
              </TouchableOpacity>
            </View>
          )}
          ...
          {selectedOrder.status === "Menuju Pickup" && (
            <View style={styles.dualActionsRow}>
              ...
              <TouchableOpacity
                ...
                activeOpacity={0.8}
              >
                <Text style={styles.sheetBtnTextSolid}>Kurir Tiba di Dapur</Text>
              </TouchableOpacity>
            </View>
          )}
