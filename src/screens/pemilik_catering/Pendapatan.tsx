          ...
          <View style={styles.cardGroupBody}>
            {withdrawals.length === 0 ? (
              ...
              withdrawals.map((record, index) => {
                const statusColor = record.status === "Sukses" ? "#1B7A4E" : record.status === "Gagal" ? "#B91C1C" : "#D97706";
                const statusBg = record.status === "Sukses" ? "#E8F5EE" : record.status === "Gagal" ? "#FEE2E2" : "#E8F5EE";
